...
export const featuredProjects: PortfolioProject[] = [
  {
    ...
    imageHint:
      "Print da dashboard, editor de template ou fluxo de assinatura do Draftos.",
  ...
  },
  {
    ...
    imageHint:
      "Print da hero, da seção de produto ou da jornada de onboarding.",
  ...
  },
  {
    ...
    imageHint:
      "Print da tela inicial mobile ou da listagem com cards e favoritos.",
...
export const inProgressProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    imageSrc: "",
    imageHint:
      "Print da tela de listagem de recibos ou do relatorio consolidado.",
    highlights: [
